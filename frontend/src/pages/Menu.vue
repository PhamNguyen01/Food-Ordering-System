            ...
            <div class="col-sm-4 col-12 filter-box">
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="10,20" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between">$10 - $20 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="mtPrice" value="20" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="mtPrice" class="d-flex justify-content-between">{{ ">" }} $20 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        ...
                        <li>
                            <input type="button" name="rType" id="vType" value="special" hidden
                                @click="filterTypeBtn($event)" />
                            <label for="vType" class="d-flex justify-content-between">special<button class="unselect-btn"
                                    @click="unselectTypeBtn($event)">X</button></label>
                        </li>
                    </ul>
                </div>
    ...
    methods: {
        ...
        evaluateStatus: function (food, statusArray) {
            ...
            if (statusArray.length != 0) {
                if (this.checkSale(food, statusArray) && this.checkBest(food, statusArray) && this.checkNew(food, statusArray)) {
                    return food;
                }
            }
            else {
