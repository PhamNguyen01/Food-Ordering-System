    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Original Taste From Italy 😋</h3>
                <p>We Guarantee To Use Fresh Food With The Best Quality. Customers Will Enjoy Pizzas With Traditional Italian Flavors.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/pizzabackground.png" alt="" class="home-img">
            </div>
        </div>
        ...
        <div class="home-banner">
            <div class="grid-banner row">
                <div class="grid col-md-4">
                    <img src="../assets/images/specialoffer.jpeg" alt="">
                    <div class="content">
        ...
        <div class="home-about">
            <div class="content">
                ...
                <h3 class="title">What's make our food special and appealing?!</h3>
                <p>Food to customers is always guaranteed of the best quality. 
                    Our dishes are made by highly skilled chefs from Italy impressive flavors 
                    and standard with the traditional taste of italian pizza. </p>
